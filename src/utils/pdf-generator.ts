...
export const generateReciept = async (
  ...
  return file as {
    content: (Content | ContentColumns | ContentStack)[];
    styles: any;
  };
};
        ...
        table: {
          ...
          body: [
            ...
            ...products.map((prod: any) => [
              ...
              {
                text: `N${prod?.price}.00`,
                alignment: "right",
                margin: [15, 10],
                fontSize: 10,
              },
              {
                text: `$${prod?.price * prod?.quantity}.00`,
                alignment: "right",
                fontSize: 10,
                margin: [15, 10],
              },
...
export const generatePDFFile = async (
  ...
  switch (type) {
    case "invoice":
      result = await generateOrder(user, order, product, address);
      break;
    case "receipt":
      result = await generateReciept(user);
      break;
    default:
