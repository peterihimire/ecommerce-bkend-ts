...
exports.generatePDFFile = exports.generateOrder = exports.generateReciept = void 0;
const generateReciept = async (data) => {
    console.log(data);
...
const generateOrder = async (user, order, products, address) => {
    const docDefinition = {
        content: [
            {
                columns: [
            ...
            },
            {
                ...
                table: {
                    ...
                    body: [
                        ...
                        ...products.map((prod) => [
                            {
                                text: `${prod === null || prod === void 0 ? void 0 : prod.title}`,
                                margin: [15, 10],
                                fontSize: 10,
                            },
                            {
                                text: `${prod === null || prod === void 0 ? void 0 : prod.quantity}`,
                                margin: [15, 10],
                                fontSize: 10,
                            },
                            {
                                text: `N${prod === null || prod === void 0 ? void 0 : prod.price}.00`,
                                alignment: "right",
                                margin: [15, 10],
                                fontSize: 10,
                            },
                            {
                                text: `$${(prod === null || prod === void 0 ? void 0 : prod.price) * (prod === null || prod === void 0 ? void 0 : prod.quantity)}.00`,
                                alignment: "right",
                                fontSize: 10,
                                margin: [15, 10],
                            },
                ...
                table: {
                    ...
                    body: [
                        [
                            ...
                            {
                                text: `$${order === null || order === void 0 ? void 0 : order.totalPrice}`,
                                alignment: "right",
                                color: "#000",
                                // fillColor: "#46C35F",
                                fontSize: 10,
...
const generatePDFFile = async (type, user, order, product, address) => {
    let result;
    switch (type) {
        case "invoice":
            result = await (0, exports.generateOrder)(user, order, product, address);
            break;
        case "receipt":
            result = await (0, exports.generateReciept)(user);
            break;
        default:
            console.log("Unknown PDF file.");
            break;
    }
    console.log("Result:", result); // Log the value of 'result' for debugging
    return result;
};
