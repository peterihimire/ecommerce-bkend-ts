...
exports.generatePDFFile = exports.generateReciept = void 0;
...
const generatePDFFile = async (type, data) => {
    let result;
    switch (type) {
        case "invoice":
            result = await (0, exports.generateReciept)(data);
            break;
        case "receipt":
            result = await (0, exports.generateReciept)(data);
            break;
...
// export const generateReciept = async (data: any) => {
//   console.log(data);
//   return {
...
// };
// export const generatePDFFile = async (type: string, data: any) => {
//   let result;
//   switch (type) {
//     case "invoice":
