...
const admin_auth_route_1 = __importDefault(
  require("./routes/admin-auth-route")
);
...
const file_filter = (req, file, cb) => {
  ...
  if (fileSize > 500000) {
    cb(
      new base_error_1.default(
        "Images must be under 500kb!",
        http_status_codes_1.httpStatusCodes.UNPROCESSABLE_ENTITY
      ),
      false
    );
  }
...
app.use(
  ...
  express_1.default.static(
    path_1.default.join(__dirname, "../../documents/pdf")
  )
);
app.use(
  "/api/ecommerce/v1/admins/auth",
  (0, express_session_1.default)(sessionOptionsTwo),
  admin_auth_route_1.default
);
app.use(
