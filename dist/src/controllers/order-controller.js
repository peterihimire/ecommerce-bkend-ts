                    ...
                    table: {
                        ...
                        body: [
                            ...
                            ...order_products.map((prod) => [
                                ...
                                { text: `${prod === null || prod === void 0 ? void 0 : prod.quantity}`, margin: [15, 10] },
                                {
                                    text: `₦${prod === null || prod === void 0 ? void 0 : prod.price}`,
                                    alignment: "right",
                                    margin: [15, 10],
                                    fontSize: 12,
                                },
                                {
                                    text: `₦${(prod === null || prod === void 0 ? void 0 : prod.price) * (prod === null || prod === void 0 ? void 0 : prod.quantity)}`,
                                    alignment: "right",
                                    fontSize: 12,
                                    margin: [15, 10],
                                },
                    ...
                    table: {
                        ...
                        body: [
                            [
                                ...
                                {
                                    text: `${created_order === null || created_order === void 0 ? void 0 : created_order.totalPrice}`,
                                    alignment: "right",
                                    color: "#000",
                                    // fillColor: "#46C35F",
                                    fontSize: 14,
